...
Modeling a social networking system like LiveJournal or Facebook in a JSON-document-oriented database like [Couchbase](http://couchbase.com) [[Lite](http://www.couchbase.com/mobile#lite)] or [CouchDB](http://couchdb.apache.org) isn't hard. Here's a basic schema that I've been playing with for a while.
